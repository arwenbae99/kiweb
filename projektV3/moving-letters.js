...
document.addEventListener("mousemove", function (event) {
    ...
    if (mouseX < centerOfScreenX) {
        Movement = mapRange(mouseX, 0, centerOfScreenX, 200, 0);
    } else {
        Movement = (mapRange(mouseX, centerOfScreenX, window.innerWidth, 0, 200) * -1);
    }

    // Update Location
    document.documentElement.style.setProperty("--movement", Movement + "px");
